...
const isValidCommentApprove = (value) => {
  if(!typeof(value)=== Boolean) {
    return "approve shoud be in boolean format";
  }
 }

let isValidCommentType = (value) => {
  let roleArr = ["comment"];
  if (!roleArr.includes(value)) {
    return "please input valid role";
  }
